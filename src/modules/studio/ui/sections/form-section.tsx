...
// Try to use ai to generate this next time
...
export const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
  ...
  const update = trpc.videos.update.useMutation({
    onSuccess: () => {
      // The invalidate function is to clear the cache of browser
      // Because data has been updated, the old data in the cache is staled
      // After clearing cache, the data in this page will be refresh automatically, no need to refresh
  ...
  const generateTitle = trpc.videos.generateTitle.useMutation({
    onSuccess: () => {
      toast.success("Title generated", { description: "" });
    },
    onError: (error) => {
      toast.error(error.message);
    },
  ...
  const generateDescription = trpc.videos.generateDescription.useMutation({
    onSuccess: () => {
      toast.success("Description generated", { description: "" });
    },
    onError: (error) => {
      toast.error(error.message);
    },
